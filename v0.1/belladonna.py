	...
	class new_at_:
		...
		def data(self, payload, object_path, outer_class):
			...
			with open(object_path, 'a+' ) as object_file:
				object_file.writelines(f"{payload}\n")
...
if __name__ == "__main__":
	...
	db.new.table("test_table", "teste", db)
	db.new.column("test_column", "test_table", "test", db)
	db.new.object("test_object", "test_column", "test_table", "test", db)
	db.new.data("value_x = 90", "test_object", "test_column", "test_table", "test", db)
	db.new.data("value_y = 80", "test_object", "test_column", "test_table", "test", db)
	db.new.data("value_z = 70", "test_object", "test_column", "test_table", "test", db)
	db.read.database("test", db)
	db.read.table("test_table", "test", db)
	db.read.column("test_column", "test_table", "test", db)
	db.read.object("test_object", "test_column", "test_table", "test", db)
	db.new.database("test2", db)
	db.edit.database("test_2", "test2", db)
	db.new.table("test_table__2", "test_2", db)
	db.edit.table("test_2/test_table_2", "test_2/test_table__2", db)
	db.new.column("test_column_2", "test_table_2", "test_2", db)
	db.new.column("test_column_3", "test_table_2", "test_2", db)
	db.new.object("test_object_test", "test_column_3", "test_table_2", "test_2", db)
	db.edit.column("test_2/test_table_2/test_column_3", "test_2/test_table_2/test_column_4", db)
	db.edit.object("test_2/test_table_2/test_column_3/test_object_test_2", "test_2/test_table_2/test_column_3/test_object_test_3", db)
	db.delete.table("teste/test_table", db)
