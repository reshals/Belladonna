...
if __name__ == "__main__":
	...
	db.add.data("value_x = 90", "test_object", "test_column", "test_table", "test", db)
	db.add.data("value_y = 80", "test_object", "test_column", "test_table", "test", db)
	db.add.data("value_z = 70", "test_object", "test_column", "test_table", "test", db)
